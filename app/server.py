#cd my-agent-name && make install && make playground# Copyright 2025 Google LLC
#
...
bucket_name = f"gs://{project_id}-agenthub-logs-data"
...
agent_name = os.environ.get("AGENT_ENGINE_SESSION_NAME", "agenthub")
...
app.title = "agenthub"
app.description = "API for interacting with the Agent agenthub"
